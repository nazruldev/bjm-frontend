...
import { type HutangGrouped, type HutangInvoice } from "@/services/hutangService";
...
export const createHutangGroupedColumns = (
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex items-center gap-2">
        <span className="font-medium">{formatCurrency(row.original.totalHutang)}</span>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="font-semibold text-destructive">
        {formatCurrency(row.original.sisaHutang)}
      </div>
    ),
  },
  {
